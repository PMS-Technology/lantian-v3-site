...
const testimonials = [
  {
    name: "R",
    username: "@RobotProof",
    body: "你们服务器的硬件的确不错，算是我见过公益服务器里最好的 T0 档位，不舍得走。",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "L",
    username: "@LikeYouth",
    body: "蓝天云牛逼，蓝天云的云计算真不错，是个好东西。",
  ...
  },
  {
    name: "Q",
    username: "@QPGFAN",
    body: "蓝天云的面板服是我见过最好用的了。",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "P",
    username: "@perrydayeye",
    body: "牛逼，下次还来。",
  ...
  return (
    <div className="relative w-full max-w-xs overflow-hidden rounded-3xl border border-white/10 bg-linear-to-b from-white/5 to-white/2 p-10 shadow-[0px_2px_0px_0px_rgba(255,255,255,0.1)_inset]">
      ...
      <div className="mt-5 flex items-center gap-2">
        <img src={img || "/placeholder.svg"} alt={name} height="40" width="40" className="h-10 w-10 rounded-full" loading="lazy" decoding="async" />
    ...
    <section id="testimonials" className="mb-24">
      <div className="mx-auto max-w-7xl">
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <div className="absolute inset-x-0 -bottom-px mx-auto h-0.5 w-1/2 bg-linear-to-r from-transparent via-[#e78a53] to-transparent shadow-2xl transition-all duration-500 group-hover:h-px"></div>
               <span className="relative text-white">用户评价</span>
            </button>
          </div>
          <h2 className="from-foreground/60 via-foreground to-foreground/60 dark:from-muted-foreground/55 dark:via-foreground dark:to-muted-foreground/55 mt-5 bg-linear-to-r bg-clip-text text-center text-4xl font-semibold tracking-tighter text-transparent md:text-[54px] md:leading-15 __className_bb4e88 relative z-10">
             来看看服主们怎么说
          </h2>

          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
             留言者信息按官网说明做了部分隐藏，更多评价可前往 QQ 社区查看。
          </p>
        </div>
        ...
        <div className="-mt-8 flex justify-center">
          <a
            href="https://developer.lantian.pro/"
            target="_blank"
