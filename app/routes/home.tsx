    ...
    <div className="min-h-screen w-full relative bg-black">
      ...
      >
        <a
          ...
          href="https://lantian.pro/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img src="/lantian-logo.png" alt="蓝天云 Logo" className="h-8 w-auto object-contain" />
        </a>
        ...
        <div className="pointer-events-none absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium text-muted-foreground transition duration-200 hover:text-foreground md:flex md:space-x-2">
          <a
            className="pointer-events-auto relative px-4 py-2 text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
            href="#features"
            onClick={(e) => {
              e.preventDefault()
          ...
          >
            <span className="relative z-20">项目亮点</span>
          </a>
          <a
            className="pointer-events-auto relative px-4 py-2 text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
            href="#pricing"
          ...
          >
            <span className="relative z-20">核心数据</span>
          </a>
          <a
            className="pointer-events-auto relative px-4 py-2 text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
            href="#testimonials"
          ...
          >
            <span className="relative z-20">服主评价</span>
          </a>
          <a
            className="pointer-events-auto relative px-4 py-2 text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
            href="#faq"
          ...
          >
            <span className="relative z-20">常见问答</span>
          </a>
        </div>

        <div className="relative z-50 flex items-center gap-4">
          <a
            href="https://next.lantian.pro/login"
            className="font-medium transition-colors hover:text-foreground text-muted-foreground text-sm cursor-pointer"
            aria-label="登录到蓝天云控制台"
          >
            登录
          </a>

          <a
            href="https://next.lantian.pro/register"
      ...
      <header className="sticky top-4 z-9999 mx-4 flex w-auto flex-row items-center justify-between rounded-full bg-background/80 backdrop-blur-sm border border-border/50 shadow-lg md:hidden px-4 py-3">
        <a
          ...
          rel="noopener noreferrer"
        >
          <img src="/lantian-logo.png" alt="蓝天云 Logo" className="h-7 w-auto object-contain" />
        </a>
