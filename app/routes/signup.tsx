...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.password !== formData.confirmPassword) {
      console.log("[蓝天云] Password mismatch")
      return
    }
    setIsLoading(true)
    ...
    setIsLoading(false)
    console.log("[蓝天云] Signup attempt:", formData)
  }
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400">加入数千名使用蓝天云构建服务的开发者</p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start space-x-2">
              ...
              <label htmlFor="terms" className="text-sm text-zinc-300">
                 我同意{" "}
                <Link to="#" className="text-[#e78a53] hover:text-[#e78a53]/80">
                   服务条款
                </Link>{" "}
                 与{" "}
                <Link to="#" className="text-[#e78a53] hover:text-[#e78a53]/80">
          ...
          <div className="mt-6 text-center">
            <p className="text-zinc-400">
               已有账号？{" "}
              <Link to="/login" className="text-[#e78a53] hover:text-[#e78a53]/80 font-medium">
                 去登录
              </Link>
            </p>
          </div>
