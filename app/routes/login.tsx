...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false)
    console.log("[蓝天云] Login attempt:", { email, password })
  }
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400">登录你的账号以继续</p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 text-sm">
                ...
                />
                <span className="text-zinc-300">记住我</span>
              </label>
              <Link to="#" className="text-sm text-[#e78a53] hover:text-[#e78a53]/80">
                忘记密码？
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-zinc-400">
               还没有账号？{" "}
              <Link to="/signup" className="text-[#e78a53] hover:text-[#e78a53]/80 font-medium">
                 去注册
              </Link>
            </p>
          </div>
        ...
        >
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
               <span className="px-2 bg-black text-zinc-500">或使用以下方式继续</span>
            </div>
          </div>
